	...
	<body class="no-skin">
		...
		<!-- /section:basics/navbar.layout -->
			...
			<div class="main-content">
				<div class="main-content-inner">
			 		<iframe name="mainFrame" id="mainFrame" frameborder="0" marginheight="0" height="100%" width="100%" style="margin-bottom:-5px" onload="cmainFrame();"  src="${contextPath}/welcome"></iframe>  
				</div>
			</div><!-- /.main-content -->
		...
		<script type="text/javascript">
			...
			function menuActive(item){
			 ...
			 function getChildMenus(childs) {
				 var s = "";
				 for (var key in childs) {
					 s += '<li id="' + childs[key].id + '">\
							 <a target="mainFrame" href="${contextPath}'+ childs[key].url +'" onclick="menuActive(this);">\
							 	<i class="menu-icon fa fa-caret-right"></i>' + childs[key].name + ' \
							 </a>\
							</li>';
				 }
				 return s;
			 ...
			 jQuery(function($) {
				 var allMenus = ${USER_MENUS};

				 for (var key in allMenus) {
					 $("#mainNav").append(
							 '<li class="active open">\
                                 <a href="#" class="dropdown-toggle" >\
								 <i class="menu-icon fa ' + allMenus[key].icon + '"></i>\
										 <span class="menu-text">' + allMenus[key].name + '</span>\
										 <b class="arrow fa fa-angle-down"></b>\
								 </a>\
								 <b class="arrow"></b>\
								 <ul class="submenu">' + getChildMenus(allMenus[key].childs) + '</ul>\
							  </li>');
				 }
			...
			// 加载菜单
			 /*
			 $.ajax({
				 url: "http://privilege.vivo.xyz:8082/menus/token/11065550/sys/privilege",
				 //data: 'id='+parent_id,
				 type: 'GET',
				 //dataType: 'json',
