...
public class WebUtil {
    ...
    public static String getSuccessJson(String message, Object data, Integer totalItem, Class<?> clazz, String... properties) {
        JSONObject resultJson = new JSONObject();
        resultJson.put(JSON_RESULT_MESSAGE, message);
        resultJson.put(JSON_RESULT_STATUS_CODE, OK);
        resultJson.put(JSON_RESULT_DATA, data);
        ...
        return JSON.toJSONString(resultJson, filter);
    }
