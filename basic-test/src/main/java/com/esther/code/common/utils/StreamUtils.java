package com.esther.code.common.utils;
...
public class StreamUtils {
	 ...
	 * 
	 */
	public static String InputStreamTOJsonString(HttpServletRequest request) {
		...
		String string = InputStreamTOString(in).replace("%22", "\"").replace("%7B", "{").replace("%7D", "}")
